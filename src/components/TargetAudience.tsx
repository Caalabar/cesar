          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                "É para quem deseja uma relação conjugal amorosa e profunda;",
                "É para quem deseja apresentar seus filhos maduros diante de Deus;",
                "É para quem ainda não aprendeu a lidar com as dores da vida: solidão, perdas, despreso e rejeição, luto, etc.",
                "É para aqueles que se encontram ansiosos (com pânico, TOC, agitados, irritados);",
                "É para aqueles que se encontram desanimados e/ou deprimidos."
              ].map((item, index) => (
